// Ajedrez.cpp : define los comportamientos de las clases para la aplicación.
//
...
// El único objeto CAjedrezApp

CAjedrezApp theApp;


// Inicialización de CAjedrezApp
